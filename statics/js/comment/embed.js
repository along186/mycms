        ...
        addModel = {
                    ...
                    if (rs.content) {
                        post.append('<li class="ds-post">\
                                      <div class="ds-post-self">\
                                          <div class="ds-avatar">\
                                            <a rel="nofollow author" href="javascript:;;" title="' + rs.author + '"><img src="/statics/images/member/touxiang.jpg" onerror="this.src=\'' + init.DOMAIN + 'statics/images/member/nophoto.gif\'"></a>\
                                          </div>\
                    ...
                    jQuery.each(json.child, function (i, rs) {
                        ...
                        if (rs.display == 'none') {
                            ...
                            strHtml += '\
                                  <li class="ds-post">\
                                    <div class="ds-post-self">\
                                      <div class="ds-avatar"><a rel="nofollow author" href="javascript:;;" title="' + rs.author + '"><img src="/statics/images/member/touxiang.jpg" alt="' + rs.author + '"></a></div>\
                                      <div class="ds-comment-body">\
            ...
            replybox: function () {
                return '<form class="ds_form_post" method="post">\
                            ...
                            <a class="ds-avatar" href="javascript:;;"><img src="/statics/images/member/touxiang.jpg" onerror="this.src=\'' + init.DOMAIN + 'statics/images/member/nophoto.gif\'"></a>\
            ...
            getUser: function () {
                ...
                var qtHtml = '<tr>\
                                  <td>手机：</td>\
                                    <td><input name="author_url" class="J_CmFormField"/></td>\
                                    <td></td>\
                                    <td>' + tis + '</td>\
                                  </tr>';
                if (init.users.user_id) {
