$(function(){
	...
	var movingDistance	    = 90;//每次移动的距离
	var curWidth			= 120;//当前中间li的宽度为120px
	var curHeight         =120;//当前中间li的高度未312  
	var curImgWidth  =120;
	var curImgHeight  =120;
	var othersW           =90;//其他li的宽度
	var othersH           =90;//高度
	var othersImgW           =90;//其他li的宽度
	var othersImgH           =90;//高度
