...
<div class="wrap ">
  ...
  <table width="100%" cellspacing="0">
      <form action="{:U("Contents/Createhtml/update_urls")}" method="post" name="myform">
...
<script language="JavaScript">
	function change_model(modelid) {
		window.location.href=GV.DIMAUB+'index.php?a=update_urls&m=Createhtml&g=Contents&modelid='+modelid;
	}
</script>
</body>
</html>