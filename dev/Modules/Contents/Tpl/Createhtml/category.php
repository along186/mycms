...
<div class="wrap J_check_wrap">
  ...
  <table width="100%" cellspacing="0">
      <form action="{:U("Contents/Createhtml/category")}" method="post" name="myform">
...
<script language="JavaScript">
	function change_model(modelid) {
		window.location.href=GV.DIMAUB+'index.php?a=category&m=Createhtml&g=Contents&modelid='+modelid;
	}
</script>
</body>
</html>