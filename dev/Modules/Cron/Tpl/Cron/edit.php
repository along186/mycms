<?php if (!defined('IIT_VERSION')) exit(); ?>
...
<div class="wrap">
  ...
  <div class="prompt_text">
    <ol>
      ...
      <li>关于计划任务的添加，您需要上传相应执行文件到 IIT/Lib/Cron/目录下,文件名必须为IITCMSxx.php形式</li>
    </ol>
  </div>
    ...
    <div class="table_full">
      <table width="100%">
        ...
        <tr>
          ...
          <td><div class="fun_tips">刷新栏目：IITCMSRefresh_category.php，属性自定义页面：IITCMSRefresh_custompage.php</div></td>
        </tr>
