-- ----------------------------
-- Table structure for `IITcms_search`
-- ----------------------------
DROP TABLE IF EXISTS `IITcms_search`;
CREATE TABLE `IITcms_search` (
...
DROP TABLE IF EXISTS `IITcms_search_keyword`;
CREATE TABLE `IITcms_search_keyword` (
