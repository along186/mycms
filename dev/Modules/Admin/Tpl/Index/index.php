  ...
  <table width="100%" height="100%" style="table-layout:fixed;">
    <tr class="head">
      <td><div class="nav"> 
        ...
        <div class="login_info"><span class="mr10">{$User.role_name}： {$User.username}</span><a href="{:U('Public/logout')}" class="mr10">[注销]</a><a href="{$Config.siteurl}" class="home" target="_blank">前台首页</a><a href="javascript:;;" id="deletecache" class="home"  style="color:#FFF">缓存更新</a></div></td>
    </tr>
    <tr class="tab">
    ...
    <tr class="content">
      <td valign="top">
        <table width="100%" height="100%">
          <th style="overflow:hidden;border-right: 1px solid #CCC; width:140px;"> 
        <div id="B_menunav">
          <div class="menubar">
            <dl id="B_menubar">
