-- ----------------------------
-- Table structure for `IITcms_collection_content`
-- ----------------------------
DROP TABLE IF EXISTS `IITcms_collection_content`;
CREATE TABLE `IITcms_collection_content` (
...
-- ----------------------------
-- Table structure for `IITcms_collection_history`
-- ----------------------------
DROP TABLE IF EXISTS `IITcms_collection_history`;
CREATE TABLE `IITcms_collection_history` (
...
-- ----------------------------
-- Table structure for `IITcms_collection_node`
-- ----------------------------
DROP TABLE IF EXISTS `IITcms_collection_node`;
CREATE TABLE IF NOT EXISTS `IITcms_collection_node` (
...
-- ----------------------------
-- Table structure for `IITcms_collection_program`
-- ----------------------------
DROP TABLE IF EXISTS `IITcms_collection_program`;
CREATE TABLE `IITcms_collection_program` (
  `id` int(10) unsigned NOT NULL auto_increment,
