<?php if (!defined('LONG_VERSION')) exit(); ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
          ...
          <div class="content" style="padding: 5px 0px 3px;overflow: hidden;">
              <form method="post" action="{:U('Index/post')}" id="myform" name="myform">
                  ...
                  <table cellspacing="0" class="feedback">
					...
					?>
					<tr>
						<th><if condition=" $info['star'] "><font color="red">*</font></if> {$info['name']}：</th> 
