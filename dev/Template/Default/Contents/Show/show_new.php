...
<div class="banner"><img src="{$Categorys[$Categorys[$catid]['parentid']]['image']}" /></div>
<template file="Contents/search.php" />
<div class="mxjj">
<div class="tb">
<a>{$Categorys[$Categorys[$catid]['parentid']]['catname']}</a>
</div>
<div class="tl">
<a>{$title}</a>
</div>
...
<ul class="first">
<li class="jianjie">
<a>新闻作者：{$author}    信息来源：{$from}    更新时间：{$updatetime}</a></li>
</ul>
</div>
<div class="tx">
{$content}
